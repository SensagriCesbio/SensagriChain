...
void writeListSample (itk::Statistics::ListSample<itk::VariableLengthVector<float>>::Pointer ListSample, std::string filename)
{
   std::ofstream myfile;
   ...
   myfile.precision(6);
    ...
    {
         itk::VariableLengthVector<float> Sample = ListSample->GetMeasurementVector(i);

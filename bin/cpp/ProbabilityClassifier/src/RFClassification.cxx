...
int main(int argc, char * argv[])
{
    ...
    unsigned int NbFeaturesForEachDate = static_cast<unsigned int>(atoll(argv[8]));
    unsigned int NbDates = static_cast<unsigned int>(atoll(argv[9]));
    ...
    classifier->SetMaxNumberOfTrees(100);
  	...
  	classifier->SetComputeMargin(true);
